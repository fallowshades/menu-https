...
## acctually wrap the store arround the user journey
...
```sh
npm install @reduxjs/toolkit@latest axios@latest react-redux@latest react-router-dom@latest
```

[post-css] https://tailwindcss.com/docs/installation

[create-instance] https://axios-http.com/docs/instance

- what headers to accept?

- types axios, fetch, what method to fetch

tsconfig.json

- types of the filebased routes
...
- there exist a dev server around the app
...
- wrapp store arout main and import the typeof get and dispatch
- there exist 3 tsconfig, be carefull how you cpy

Root.tsx

- fix load issues in next commit
...
- my good i have had problems with loader
- but console.log just does not log
...
- also had to inc slice
- also dont filter logs, cant see them in google console.
